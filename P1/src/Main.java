...
//        System.out.print("\033[40;7;35m \033[0m"); // Pinta de magenta
        ...
        while (!caminhoes.isEmpty() || !motinhas.isEmpty() || !carros.isEmpty())
        {
            ...
            System.out.print("\033[40;7;31m  \033[0m Moto:" + motinhas.size() + "    ");
            System.out.print("\033[40;7;32m  \033[0m Carro:" + carros.size() + "    ");
            System.out.print("\033[40;7;34m  \033[0m Caminhao:" + caminhoes.size() + "    ");
            System.out.println("");
